<!DOCTYPE html><html><head><meta charset="utf-8"/>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="{{url('public/frontend')}}/css/bootstrap.css"/>
...
<body>
        ...
        <div class="row">
          <div class="col-lg-8">
            <nav class="navbar navbar-expand-lg custom_nav-container ">
              ...
              <img src="{{url('public/frontend')}}/images/final_Logo.png" width="200px">
              </a>
  ...
  <script type="text/javascript" src="{{url('public/frontend')}}/js/jquery-3.4.1.min.js"></script>
