...
<div>
	   ...
	   <div style="border-top-left-radius:10px;border-top-right-radius:10px;font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e
		...
		: bicubic;display: block; max-width: 200px;" src="{{url('/public/Final Logo.png')}}" alt="" >
			...
			<p>Hello Dear <strong>{{ucfirst($dataArr['name'])}} </strong> congratulations new member <strong>{{ucfirst($dataArr['customer_name'])}} </strong>register using your referral code.</p>
			@else
			...
			@endif
				...
				<p>So, we created <strong>Growth Addicted</strong>  just for you. </p>
