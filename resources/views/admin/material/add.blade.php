            ...
            <div class="card">
              <div class="card-content">
                ...
                <div class="col s12 display-flex justify-content-end">
                    <a href="{{url('admin/all-marketing-material')}}" class="btn waves-effect waves-light purple lightrn-1"> Marketing Material List</a>
                    
                </div>
                 </div>
                   <div class="col-lg-12">
                      <form method="POST" name="banner-form" id="banner-form" action="{{url('admin/add-marketing-material')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
