              ...
              <div class="card-content">
                ...
                @endif
                  ...
                  ?>
                   ...
                   <div class="col-lg-12">
                      <form method="POST" name="banner-form" id="banner-form" action="{{url('admin/upgrade-packages-price')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                          ...
                          <div class="col m3 s12">
                                <label>Upgrade Package <sup style="color:red;">*</sup> </label>
                          ...
                          <div class="col m3 s12">
                                ...
                                <input type="number" name="directIncome[]" value="{{$row->direct_comm}}">
                          </div>
