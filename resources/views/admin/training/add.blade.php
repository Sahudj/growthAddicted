            ...
            <div class="card">
              <div class="card-content">
                ...
                <div class="col s12 display-flex justify-content-end">
                    <a href="{{url('admin/training-listing')}}" class="btn waves-effect waves-light purple lightrn-1"> Training List</a>
                    
                </div>
                 </div>
                   <div class="col-lg-12">
                      <form method="POST" name="banner-form" id="banner-form" action="{{url('admin/add-training')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                          <div class="col s6">
