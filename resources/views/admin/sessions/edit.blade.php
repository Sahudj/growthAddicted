            ...
            <div class="card">
              <div class="card-content">
                ...
                <div class="col s12 display-flex justify-content-end">
                   ...
                   <div class="col-lg-12">
                      <form method="POST" name="banner-form" id="banner-form" action="{{url('admin/edit-session')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                          <div class="col s6">
                          ...
                          <div class="col s6">
                              ...
                              <img src = "{{url('public/QAsession/'.$getDetails->thumbnail)}}" width="100px"> <br>
