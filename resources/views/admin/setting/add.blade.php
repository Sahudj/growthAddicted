              ...
              <div class="card-content">
                <div class="col-lg-12">
                  ...
                  <br>
                   ...
                   <div class="col-lg-12">
                      <form method="POST" name="banner-form" id="banner-form" action="{{url('admin/add-setting')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <div class="row">
                        <div class="col m4 s12">
                              <label> Meta Key <sup style="color:red;">*</sup> </label>
                              <input type="text" name="meta_key[]" id="meta_key" class="form-control" value="" placeholder="Enter Meta Key" required>
                              @error('email')
                            ...
                            <div class="col m8 s12">
                              ...
                              <input type="text" name="meta_value[]" id="meta_value" class="form-control" value="" placeholder="Enter Meta Value" required>
                              @error('email')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
