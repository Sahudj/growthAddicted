                  ...
                  <div class="col s12 l3">
                       ...
                       <div class="card recent-buyers-card animate fadeUp">
                          <div class="card-content">
                             <h4 class="card-title mb-0">Todays </h4>
                            
                             <ul class="collection mb-0">
                              @if(isset($todaysData) && !empty($todaysData))
                                @foreach($todaysData as $row)
                                  <li class="collection-item avatar">
                                   ...
                                   @endif
                                   <p class="font-weight-600" style="margin: 3px; width: 15px;">{{ucfirst($row->name)}}</p>
                                   <P style="font-size: 15px;" class="secondary-content"> <strong>₹ {{$row->amount}}</strong> </P>
                                </li>
                                @endforeach
                              @endif
                             </ul>
                             ...
                             <ul class="collection mb-0">
                                ...
                                @foreach($allTime as $row)
                                  <li class="collection-item avatar">
                                   ...
                                   @endif
                                   <p class="font-weight-600" style="margin: 3px; width: 15px;">{{ucfirst($row->name)}}</p>
                                   <p class="secondary-content" style="font-size: 15px;"><strong>₹ {{$row->amount}}</strong></p>
                                </li>
                                @endforeach
                              @endif
                             </ul>
