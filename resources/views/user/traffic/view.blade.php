                               ...
                               <ul class="collection mb-0">
                                  ...
                                  <li class="collection-item avatar" style="padding-left: 10px !important;">
                                      ...
                                      <a class="secondary-content">
                                          <strong>{{$getDetails->direct_income}}</strong> 
                                      </a>
                                  </li>
                               </ul>
                            </div>
               ...
               <div class="card-content">
                 ...
                 <hr>
                  ...
                  <div>
                    ...
                    <hr>
                  <div>
                    Commission<p class="secondary-content" style="margin:0px !important; color:#5F6EC1; font-size: 20px !important"> {{$getDetails->direct_income}} </p>
                  </div>
